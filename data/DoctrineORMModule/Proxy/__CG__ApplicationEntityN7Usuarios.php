 ...
 */
class N7Usuarios extends \Application\Entity\N7Usuarios implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\N7Usuarios' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\N7Usuarios' . "\0" . 'usuario', '' . "\0" . 'Application\\Entity\\N7Usuarios' . "\0" . 'clave');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (N7Usuarios $proxy) {
