...
/**
 * N7VistasPropiedadesE
 *
 * @ORM\Table(name="n7_vistas_propiedades_e", indexes={@ORM\Index(name="Index_2", columns={"propiedad_id"}), @ORM\Index(name="Index_3", columns={"formulario_id"})})
 * @ORM\Entity
 */
class N7VistasPropiedadesE
{
    /**
     * @var integer
     *
